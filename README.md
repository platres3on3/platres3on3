...
<body>
    ...
    <div class="content" id="english-content">
        ...
        <h5>Registrations will be open from 1st May to 10th May 2024 through the link <a href="https://forms.office.com/r/NkmdV3gJKs?origin=lprLink">here</a>.</h5>
        <h5>The registration cost for a player is €35 which will cover:</h5>
        <ul>
    ...
    <div class="content" id="greek-content" style="display: none;">
        ...
        <h1>Καλώς ήρθατε στο Platres 3on3</h1>
        <ul>
            <li>Ημερομηνία: 2 Ιουνίου 2024</li>
            <li>Τοποθεσία: <a href="https://platresarena.com/">Platres Arena</a>, Πλάτρες.</li>
        </ul>
        <p>
            <p style="text-align: justify;">Μετά από μια άκρως επιτυχημένη προσπάθεια, το Platres 3on3 επιστρέφει στο γήπεδο των Πάνω Πλατρών για μια ακόμη διοργάνωση, με κύριο στόχο την υποστήριξη του <span style="color: #CB5996; font-weight: bold;">Ιδρύματος Μικροί Ήρωες</span> και του <span style="color: #CB5996; font-weight: bold;">Europa Donna Cyprus</span>, δύο μη κερδοσκοπικών οργανισμών οι οποίοι παρέχουν βοήθεια και στήριξη σε παιδιά τα οποία παλεύουν με την λευχαιμία, σε γυναίκες και άντρες οι οποίοι αγωνίζονται κατά του καρκίνου του μαστού.</p>
        </p>
        <p>
        ...
        <h5>Οι εγγραφές θα είναι ανοικτές από 1η Μαίου έως 10 Μαΐου 2024 μέσω του συνδέσμου <a href="https://forms.office.com/r/NkmdV3gJKs?origin=lprLink">εδώ</a>.</h5>
        <h5>Το κόστος εγγραφής ανά παίχτη ανέρχεται στα €35 το οποίο θα καλύπτει:</h5>
        <ul>
